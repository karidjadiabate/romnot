...
<body>
    <div class="containers">
        ...
        <div id="icone" class="stack">
            <div id="apparence"><span><svg xmlns="http://www.w3.org/2000/svg" width="30.075" height="21.885"
                        viewBox="0 0 30.075 21.885" id="svg">
                    ...
                    </svg></span>Apparence et accessibilté</div>
            <div id="profil"><span><i class="fa-solid fa-user-group"></i></span>Profils</div>
            <div id="parametre"><span><i class="fa-solid fa-gear"></i></span>Paramètres supplémentaires</div>
        </div>
        ...
        <div id="apparence_accessibilite">
            ...
            <div class="stack">
                ...
                <div id="theme_application" class="stack">
                    <div id="theme_clair">
                        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="401.5"
                            height="317.424" viewBox="0 0 401.5 317.424">
                            <defs>
                            ...
                            <g id="Thème_défaut" data-name="Thème défaut" transform="translate(0.722 0.528)">
                                <g id="Groupe_333" data-name="Groupe 333">
                                    ...
                                    <g id="Groupe_330" data-name="Groupe 330" transform="translate(0.297 0)">
                                        <g id="Groupe_329" data-name="Groupe 329" clip-path="url(#clip-path)">
                                            <rect id="Rectangle_204" data-name="Rectangle 204" width="494.382"
                                                height="74.842" transform="translate(-43.724 -47.632)" fill="#4a41c5" />
                                        </g>
                                    </g>
                                    <g id="Groupe_332" data-name="Groupe 332" transform="translate(161.101 9)">
                                        ...
                                        <rect id="Rectangle_211" data-name="Rectangle 211" width="77.15" height="9.077"
                                            transform="translate(29.584 124.196)" fill="#d9e0fb" />
                                        <rect id="Rectangle_212" data-name="Rectangle 212" width="71.176" height="5.213"
                                            transform="translate(29.584 236.133)" fill="#d9e0fb" />
                                        <rect id="Rectangle_213" data-name="Rectangle 213" width="71.176" height="5.213"
                                            transform="translate(29.584 246.235)" fill="#d9e0fb" />
                                        <rect id="Rectangle_214" data-name="Rectangle 214" width="71.176" height="5.213"
                                            transform="translate(29.584 256.337)" fill="#d9e0fb" />
                                        <rect id="Rectangle_215" data-name="Rectangle 215" width="37.026" height="5.213"
                                            transform="translate(29.584 266.44)" fill="#d9e0fb" />
                                    </g>
                                </g>
                            </g>
                        </svg>
                    ...
                    <div id="theme_defaut">
                        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                            width="683.211" height="317.041" viewBox="0 0 683.211 317.041">
                            <defs>
                                <clipPath id="clip-path">
                                    <rect id="Rectangle_205" data-name="Rectangle 205" width="400.064" height="316.896"
                                        fill="none" />
                            ...
                            <g id="Thème_système" data-name="Thème système" transform="translate(0.25 0.145)">
                                <g id="Groupe_337" data-name="Groupe 337">
                                    <g id="Groupe_333" data-name="Groupe 333" transform="translate(0)">
                                        <rect id="Rectangle_216" data-name="Rectangle 216" width="400.436"
                                            height="305.25" transform="translate(0 0.105)" fill="#fff" stroke="#4a41c5"
                                            stroke-width="0.5" />
                                        <g id="Groupe_330" data-name="Groupe 330" transform="translate(0.297 0)">
                                            <g id="Groupe_329" data-name="Groupe 329" clip-path="url(#clip-path)">
                                                <rect id="Rectangle_204" data-name="Rectangle 204" width="494.382"
                                ...
                                <g id="Groupe_336" data-name="Groupe 336" transform="translate(282.275)">
                    ...
                    <div id="theme_sombre">
                        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                            width="400.936" height="317.041" viewBox="0 0 400.936 317.041">
                            <defs>
                                <clipPath id="clip-path">
                                    <rect id="Rectangle_205" data-name="Rectangle 205" width="400.064" height="316.896"
                                        fill="none" />
                            ...
                            <g id="Thème_dark" data-name="Thème dark" transform="translate(0.25 0.145)">
                                <g id="Groupe_333" data-name="Groupe 333" transform="translate(0)">
                                    <rect id="Rectangle_216" data-name="Rectangle 216" width="400.436" height="305.25"
                                        transform="translate(0 0.105)" fill="#050043" stroke="#4a41c5"
                                        stroke-width="0.5" />
                                    <g id="Groupe_330" data-name="Groupe 330" transform="translate(0.297 0)">
                                        <g id="Groupe_329" data-name="Groupe 329" clip-path="url(#clip-path)">
                                            <path id="Tracé_503" data-name="Tracé 503" d="M0,0H494.382V74.842H0Z"
                ...
                <div class="stack" id="creer_profil">
                    ...
                    <div class="champ stack">
                        <div class="champs">
                            ...
                            <input type="text" name="" placeholder="Entrez un nom du profil" id="input_text">
                            <div id="error1"></div>
                        </div>
                        <div class="champs">
            ...
            <div id="vue_profil" class="stacks">
                ...
                <div id="myModal" class="modal">
                    <div class="modal-content">
                        ...
                        <div id="triangle_affiche">
                            <i class="fa-solid fa-triangle-exclamation"></i>
                            <span>Êtes vous sûres?</span>
                        </div>
                        <p>Voulez-vous supprimer le profil <span id="nom_affiche"></span> ?</p>
                        <div id="button" class="stack">
                            <button type="submit" id="confirmation">Oui, je confirme</button>
                            <button type="cancel" id="annulation" class="cancel">Annuler</button>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div id="parametre_supplementaire">
            <div>
    ...
    <script>
        ...
        var parametres = document.getElementById('parametre_supplementaire');
